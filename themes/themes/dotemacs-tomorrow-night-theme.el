;;; dotemacs-tomorrow-night-theme.el
(require 'dotemacs-themes)

(defgroup dotemacs-tomorrow-night-theme nil
  "Options for dotemacs-themes"
  :group 'dotemacs-themes)

(defcustom dotemacs-tomorrow-night-padded-modeline dotemacs-themes-padded-modeline
...
(def-dotemacs-theme dotemacs-tomorrow-night
  ...
  ((bg         '("#1d1f21" nil       nil          ))
   ...
   (dark-cyan  (dotemacs-darken cyan 0.4))

   ;; face categories
   (highlight      dark-blue)
   (vertical-bar   base0)
   (selection      (dotemacs-lighten bg 0.1))
   (builtin        blue)
   (comments       grey)
   ...
   ;; custom categories
   (modeline-bg     `(,(dotemacs-darken (car bg-alt) 0.3) ,@(cdr base3)))
   (modeline-bg-alt `(,(car bg) ,@(cdr base1)))
   (modeline-fg     base8)
   (modeline-fg-alt comments)
   (-modeline-pad
    (when dotemacs-tomorrow-night-padded-modeline
      (if (integerp dotemacs-tomorrow-night-padded-modeline)
          dotemacs-tomorrow-night-padded-modeline
        4))))

  ;; --- faces ------------------------------
  ((dotemacs-modeline-buffer-path       :foreground violet :bold bold)
...
(provide 'dotemacs-tomorrow-night-theme)
;;; dotemacs-tomorrow-night-theme.el ends here
