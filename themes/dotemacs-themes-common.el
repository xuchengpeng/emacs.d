...
(defvar dotemacs-themes-common-faces
  '(;; --- custom faces -----------------------
    ...
    (org-habit-ready-face          :weight 'bold :background (dotemacs-blend blue bg-alt 0.5)   :foreground (dotemacs-blend blue bg-alt 0.5))
    (org-habit-ready-future-face   :weight 'bold :background (dotemacs-blend blue bg-alt 0.5)   :foreground (dotemacs-blend blue bg-alt 0.5))
    (org-habit-alert-face          :weight 'bold :background (dotemacs-blend yellow bg-alt 0.5) :foreground (dotemacs-blend yellow bg-alt 0.5))
    (org-habit-alert-future-face   :weight 'bold :background (dotemacs-blend yellow bg-alt 0.5) :foreground (dotemacs-blend yellow bg-alt 0.5))
    (org-habit-overdue-face        :weight 'bold :background (dotemacs-blend red bg-alt 0.5)    :foreground (dotemacs-blend red bg-alt 0.5))
    (org-habit-overdue-future-face :weight 'bold :background (dotemacs-blend red bg-alt 0.5)    :foreground (dotemacs-blend red bg-alt 0.5))
